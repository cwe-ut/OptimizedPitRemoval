...
#include <cmath>
#include <float.h>
//#include "mpi.h"  **SIMPLIFIED FROM TauDEM
...
#include <queue>
//#include "linearpart.h" **SIMPLIFIED FROM TauDEM

//bool pointsToMe(long col, long row, long ncol, long nrow, tdpartition *dirData);  **SIMPLIFIED FROM TauDEM
